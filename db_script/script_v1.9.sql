...
INSERT INTO `access_token` VALUES (8,'$2y$10$/JpTQ6d5tevC7ltHUlIlUuv2lon1zWJSDgLZ8hDh3tKPwQ/YBRUeO',0,92);
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='Cửa hàng, nhà hàng, quán ăn cà phê';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `image` VALUES (1,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C','Ảnh fb',1491718565),(2,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C','Ảnh fb',1491718630),(3,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C','Ảnh fb',1491718720),(4,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C','Ảnh fb',1491718786),(5,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C','Ảnh fb',1491719096),(6,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C','Ảnh fb',1491719153);
...
CREATE TABLE `image_dainty` (
  ...
  `fonda_dainty_id` int(11) NOT NULL,
  PRIMARY KEY (`image_id`,`fonda_dainty_id`),
...
INSERT INTO `location` VALUES (1,10.8869628,106.7563277,'Bình Dương');
...
CREATE TABLE `profile` (
  ...
  KEY `profile_location_location_id_fk_idx` (`location_id`),
  ...
  CONSTRAINT `profile_location_location_id_fk` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `profile` VALUES (10,'tùng','hồ','1995-11-26 00:00:00.000000','male',1,2,92);
...
INSERT INTO `verify_status` VALUES (75,79,'347240',1491730722,0,1),(84,92,'301762',1492161908,0,3);
...
-- Dump completed on 2017-04-12  2:21:19
