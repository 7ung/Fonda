...
CREATE TABLE `user` (
  ...
  `renew_password_token` varchar(64) DEFAULT NULL,
  `renew_password_token_expired` datetime(6) DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'111','222','333',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'abc','xyz','haha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'7ung','hihi','haha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2017-03-16 17:12:32
