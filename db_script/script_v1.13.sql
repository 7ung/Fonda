...
INSERT INTO `comment` VALUES (3,1492316144,'dumm dumm',92,1),(4,1492317763,'excellent comment',92,1),(5,1492317774,'unbeleivable',92,1);
...
CREATE TABLE `culinary` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Loại ẩm thực';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `culinary` VALUES (1,'Cà phê'),(2,'Món lẩu'),(3,'Món Thái'),(4,'Món Hàn'),(5,'Món nướng'),(6,'dumm dumm');
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='Cửa hàng, nhà hàng, quán ăn cà phê';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fonda` VALUES (1,'Đại Gia',1,3,'07:00:00','12:00:00',NULL,NULL,NULL,92,1),(3,'Hồ Vĩ Dạ',5,1,'07:00:00','19:00:00',NULL,NULL,NULL,92,1),(4,'Hồ Vĩ Dạ',4,1,'07:00:00','19:00:00',NULL,NULL,NULL,92,1),(5,'Hồ Vĩ Dạ',3,1,'07:00:00','19:00:00',NULL,NULL,NULL,92,1),(6,'Hồ Vĩ Dạ',2,1,'07:00:00','19:00:00',NULL,NULL,NULL,92,1),(15,'Urahara Shop',12,1,NULL,NULL,NULL,NULL,NULL,92,1),(20,'Urahara Shop',12,1,NULL,NULL,NULL,NULL,NULL,92,1),(21,'Urahara Shop',1,3,NULL,NULL,NULL,NULL,NULL,92,1);
...
INSERT INTO `fonda_culinary` VALUES (1,2),(1,3),(1,4),(1,6);
...
INSERT INTO `fonda_dainty` VALUES (1,1,2,'12000','2017-04-14 00:00:00.000000',1,2,'dummy',1,0);
...
CREATE TABLE `fonda_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Nhóm nhà hàng.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fonda_group` VALUES (1,'Quán cà phê bình dân'),(2,'Quán ăn gia đình'),(3,'Nhà hàng bình dân'),(4,'Buffet'),(5,'Vỉa hè'),(6,'Nhà hàng'),(7,'Quán cà phê'),(8,'Trà sữa'),(9,'dumm'),(12,'Shinigami Shop');
...
INSERT INTO `fonda_utility` VALUES (1,1,'pass: khongcopass'),(1,2,'dumm dumm'),(1,4,'dumm dumm'),(1,12,NULL);
...
INSERT INTO `image` VALUES (1,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C',NULL,'Ảnh fb',1491718565,NULL),(2,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C',NULL,'Ảnh fb',1491718630,92),(3,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C',NULL,'Ảnh fb',1491718720,92),(4,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C',NULL,'Ảnh fb',1491718786,NULL),(5,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C',NULL,'Ảnh fb',1491719096,NULL),(6,'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/16730174_782446968571874_2961317568171881099_n.jpg?oh=1e26b8f7fd307e79bac3f68a8e3a6bfe&oe=595AE56C',NULL,'Ảnh fb',1491719153,92),(18,'http://localhost:8080/storage/img/92/18.jpg',NULL,NULL,1492181265,92),(19,'http://localhost:8080/storage/img/92/19.jpg','/storage/img/92/19.jpg','',1492181346,92);
...
INSERT INTO `image_fonda` VALUES (6,1),(18,1),(19,1);
...
INSERT INTO `location` VALUES (1,10.8869628,106.7563277,'Bình Dương',10,NULL,NULL),(5,93.8184,73.188,NULL,NULL,3,NULL),(6,93.8184,73.188,NULL,NULL,4,NULL),(7,93.8184,73.188,NULL,NULL,5,NULL),(8,93.8184,73.188,NULL,NULL,6,NULL),(15,12.1,15.3,'hcm',NULL,1,NULL);
...
CREATE TABLE `sale` (
  ...
  `high_light` varchar(128) DEFAULT NULL,
  `description` varchar(512) DEFAULT NULL,
  `fonda_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `sale` VALUES (2,'2017-04-17 00:00:00.000000','2017-04-20 00:00:00.000000','dumm dumm',NULL,1),(3,'2017-04-19 00:00:00.000000','2017-04-20 00:00:00.000000',NULL,NULL,1),(5,'2017-04-19 00:00:00.000000','2017-04-20 00:00:00.000000',NULL,NULL,1);
...
CREATE TABLE `utility` (
  ...
  `name` varchar(128) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Tiện nghi của quán ăn.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `utility` VALUES (1,'Wifi'),(2,'Có chỗ gửi xe'),(3,'Máy lạnh'),(4,'Vườn hoa'),(5,'Hút thuốc'),(6,'Không hút thuốc'),(12,'dumm dumm');
...
-- Dump completed on 2017-04-26 10:51:18
