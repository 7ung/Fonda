...
INSERT INTO `fonda_culinary` VALUES (1,2),(1,3),(1,4);
...
CREATE TABLE `fonda_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Nhóm nhà hàng.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fonda_group` VALUES (1,'Quán cà phê bình dân'),(2,'Quán ăn gia đình'),(3,'Nhà hàng bình dân'),(4,'Buffet'),(5,'Vỉa hè'),(6,'Nhà hàng'),(7,'Quán cà phê'),(8,'Trà sữa');
...
INSERT INTO `fonda_utility` VALUES (1,1,'pass: khongcopass'),(1,2,'dumm dumm'),(1,4,'dumm dumm');
...
-- Dump completed on 2017-04-16  0:48:48
