...
define('SELECT_ACCESS_TOKEN_ID', 'query_select_access_token_userid');
...
const mysql_queries_1 =
    [
         ...
         *
         */
        SELECT_ACCESS_TOKEN_ID => 'select id, user_id, access_token, expired from access_token where (id = ?)',
